...
{
    public class InformationController : BaseSiteController
    {
        [Authorize(Roles = nameof(OPERATIONS.Setting_Cities))]
        ...
        //################################ Cities #######################################################
        [Authorize(Roles = nameof(OPERATIONS.Setting_Cities_Delete))]
        public ActionResult CityDelete(string Countryid, string Provinceid, string Cityid)
        {
            if (!string.IsNullOrEmpty(Cityid))
            {
                ...
                LogManager.Log_Logs_Add((int)DB_Table.Others, int.Parse(Cityid), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف شهر: " + name);
            ...
            else if (!string.IsNullOrEmpty(Provinceid))
            {
                ...
                LogManager.Log_Logs_Add((int)DB_Table.Others, int.Parse(Provinceid), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف استان: " + name);
            ...
            else if (!string.IsNullOrEmpty(Countryid))
            {
                ...
                LogManager.Log_Logs_Add((int)DB_Table.Others, int.Parse(Countryid), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف کشور: " + name);
            }
            return RedirectToAction("Cities");
        }

        [Authorize(Roles = nameof(OPERATIONS.Setting_Cities_Edit))]
        public ActionResult CityEdit(string Countryid, string CountryName, string Provinceid, string ProvinceName, string Cityid, string CityName)
        {
            if (!string.IsNullOrEmpty(Cityid))
            {
                ...
                LogManager.Log_Logs_Add((int)DB_Table.Others, int.Parse(Cityid), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, "تغییر نام شهر به " + CityName);
                return RedirectToAction("Cities", new { Countryid = Countryid, Provinceid = Provinceid });
            }
            else if (!string.IsNullOrEmpty(Provinceid))
            {
                InformationManager.Location_Province_Edit(int.Parse(Provinceid), ProvinceName);
                LogManager.Log_Logs_Add((int)DB_Table.Others, int.Parse(Provinceid), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, "تغییر نام استان به " + ProvinceName);
                return RedirectToAction("Cities", new { Countryid = Countryid, Provinceid = Provinceid });
            }
            else if (!string.IsNullOrEmpty(Countryid))
            {
                InformationManager.Location_Country_Edit(int.Parse(Countryid), CountryName);
                LogManager.Log_Logs_Add((int)DB_Table.Others, int.Parse(Countryid), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, "تغییر نام کشور به " + CountryName);
            }
            return RedirectToAction("Cities", new { Countryid = Countryid });
        }

        [Authorize(Roles = nameof(OPERATIONS.Setting_Cities_Add))]
        public ActionResult CityAdd(string Countryid, string CountryName, string Provinceid, string ProvinceName, string Cityid, string CityName)
        {
            if (!string.IsNullOrEmpty(CountryName))
            {
                ...
                LogManager.Log_Logs_Add((int)DB_Table.Others, int.Parse(Countryid), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, "افزودن کشور " + CountryName);
                return RedirectToAction("Cities", new { Countryid = Countryid });
            }
            else if (!string.IsNullOrEmpty(ProvinceName))
            {
                ...
                LogManager.Log_Logs_Add((int)DB_Table.Others, int.Parse(Provinceid), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, "افزودن استان " + ProvinceName);
                return RedirectToAction("Cities", new { Countryid = Countryid, Provinceid = Provinceid });
            }
            else if (!string.IsNullOrEmpty(CityName))
            {
                ...
                LogManager.Log_Logs_Add((int)DB_Table.Others, int.Parse(Cityid), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, "افزودن شهر " + CityName);
            }
            return RedirectToAction("Cities", new { Countryid = Countryid, Provinceid = Provinceid });
        }
        ...
        [Authorize(Roles = nameof(OPERATIONS.Setting_Order))]
        ...
        //######################################### Pack #########################################
        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_Order_Packet_Add))]
        public ActionResult AddPack(string PackName)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Others, PackId, User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, "افزودن بسته بندی " + PackName);
            return RedirectToAction("Order");
        }

        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_Order_Packet_Delete))]
        public ActionResult DeletePack(string PackId)
        {
            InformationManager.Order_Pack_Delete(packId: int.Parse(PackId));
            LogManager.Log_Logs_Add((int)DB_Table.Others, int.Parse(PackId), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف بسته بندی");
            return RedirectToAction("Order");
        }

        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_Order_Packet_Edit))]
        public ActionResult EditPack(string PackId, string PackName)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Others, int.Parse(PackId), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, "تغییر نام بسته بندی به " + PackName);
            return RedirectToAction("Order");
        }

        //######################################### ElevatorBoard #########################################
        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_Order_ElevatorBoard_Add))]
        public ActionResult AddElevatorBoard(string ElevatorBoardName)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Others, ElevatorBoardId, User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, "افزودن تابلوی " + ElevatorBoardName);
            return RedirectToAction("Order");
        }

        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_Order_ElevatorBoard_Delete))]
        public ActionResult DeleteElevatorBoard(string ElevatorBoardId)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Others, int.Parse(ElevatorBoardId), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف تابلو");
            return RedirectToAction("Order");
        }

        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_Order_ElevatorBoard_Edit))]
        public ActionResult EditElevatorBoard(string ElevatorBoardId, string ElevatorBoardName)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Others, int.Parse(ElevatorBoardId), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, "تغییر نام تابلو به " + ElevatorBoardName);
            return RedirectToAction("Order");
        }

        //####################################### Deduction #############################################
        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_Order_Deduction_Add))]
        public ActionResult AddDeduction(string DeductionName)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Deductions, deductionId, User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, "افزودن کسورات " + DeductionName);
            return RedirectToAction("Order");
        }

        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_Order_Deduction_Delete))]
        public ActionResult DeductionDelete(string DeductionId)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Deductions, int.Parse(DeductionId), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف کسورات");
            return RedirectToAction("Order");
        }

        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_Order_Deduction_Edit))]
        public ActionResult DeductionEdit(string DeductionId, string DeductionName)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Deductions, int.Parse(DeductionId), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, "تغییر نام کسورات به " + DeductionName);
            return RedirectToAction("Order");
        }

        //########################################## Addition ############################################################
        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_Order_Addition_Add))]
        public ActionResult AddAddition(string AdditionName)
        {
            int AdditionId = InformationManager.Order_Addition_Add(AdditionName);
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Additions, AdditionId, User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, "افزودن اضافات " + AdditionName);
            return RedirectToAction("Order");
        }

        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_Order_Addition_Delete))]
        public ActionResult AdditionDelete(string AdditionId)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Additions, int.Parse(AdditionId), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف اضافات");
            return RedirectToAction("Order");
        }

        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_Order_Addition_Edit))]
        public ActionResult AdditionEdit(string AdditionId, string AdditionName)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Additions, int.Parse(AdditionId), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, "تغییر نام اضافات به " + AdditionName);
            return RedirectToAction("Order");
        }



        [Authorize(Roles = nameof(OPERATIONS.Setting_Attachment))]
        ...
        //######################################### Attachment #########################################
        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_Attachment_Add))]
        public ActionResult AddAttachment(string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable, bool? IsDeliveryItem)
        {
            ...
            if (User.IsInRole(nameof(BaseSite.Models.OPERATIONS.Setting_ProductFactor)))
            {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Attachments, attachmentId, User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, InformationManager.Order_Attachment_Get().Where(m => m.Id == attachmentId).FirstOrDefault().ToString());
            return RedirectToAction("Attachment");
        }

        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_Attachment_Delete))]
        public ActionResult DeleteAttachment(string ItemId)
        {
            InformationManager.Order_Attachment_Delete(int.Parse(ItemId));
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Attachments, int.Parse(ItemId), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف ملحقات");
            return RedirectToAction("Attachment");
        }

        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_Attachment_Edit))]
        public JsonResult EditAttachment(string ItemId, string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable, bool? IsDeliveryItem)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Attachments, int.Parse(ItemId), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, InformationManager.Order_Attachment_Get().Where(m => m.Id == int.Parse(ItemId)).FirstOrDefault().ToString());

            return Json(res.First(), null);
        }


        [Authorize(Roles = nameof(OPERATIONS.Setting_PushButton))]
        ...
        //########################### PushButton ############################################
        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_PushButton_Add))]
        public ActionResult AddPushButton(string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_PushButtons, pushbuttonId, User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, InformationManager.Cabin_PushButton_Get(pushbuttonId).ToString());
            return RedirectToAction("PushButton");
        }

        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_PushButton_Delete))]
        public ActionResult DeletePushButton(string ItemId)
        {
            InformationManager.Cabin_PushButton_Delete(int.Parse(ItemId));
            LogManager.Log_Logs_Add((int)DB_Table.Tb_PushButtons, int.Parse(ItemId), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف پوش باتون: " + InformationManager.Cabin_PushButton_Get(int.Parse(ItemId)).Name);
            return RedirectToAction("PushButton");
        }

        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_PushButton_Edit))]
        public JsonResult EditPushButton(string ItemId, string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_PushButtons, int.Parse(ItemId), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, InformationManager.Cabin_PushButton_Get(int.Parse(ItemId)).ToString());
        ...
        [Authorize(Roles = nameof(OPERATIONS.Setting_Monitor))]
        ...
        //############################## Monitor #############################################
        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_Monitor_Add))]
        public ActionResult AddMonitor(string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Monitors, monitorId, User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, InformationManager.Cabin_Monitor_Get(monitorId).ToString());
            return RedirectToAction("Monitor");
        }

        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_Monitor_Delete))]
        public ActionResult DeleteMonitor(string ItemId)
        {
            InformationManager.Cabin_Monitor_Delete(int.Parse(ItemId));
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Monitors, int.Parse(ItemId), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف نمایشگر: " + InformationManager.Cabin_Monitor_Get(int.Parse(ItemId)).Name);
            return RedirectToAction("Monitor");
        }

        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_Monitor_Edit))]
        public JsonResult EditMonitor(string ItemId, string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Monitors, int.Parse(ItemId), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, InformationManager.Cabin_Monitor_Get(int.Parse(ItemId)).ToString());

            return Json(res.First(), null);
        }


        [Authorize(Roles = nameof(OPERATIONS.Setting_CabinSurfaceMetal))]
        ...
        //########################### SurfaceMetal ##########################################
        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_CabinSurfaceMetal_Add))]
        public ActionResult _AddSurfaceMetal(string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_SurfaceMetals, surfacemetalId, User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, InformationManager.SurfaceMetal_Get(surfacemetalId).ToString());
            return RedirectToAction("SurfaceMetal");
        }

        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_CabinSurfaceMetal_Delete))]
        public ActionResult _DeleteSurfaceMetal(string ItemId)
        {
            InformationManager.SurfaceMetal_Delete(int.Parse(ItemId));
            LogManager.Log_Logs_Add((int)DB_Table.Tb_SurfaceMetals, int.Parse(ItemId), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف فلزرویه: " + InformationManager.SurfaceMetal_Get(int.Parse(ItemId)).Name);
            return RedirectToAction("SurfaceMetal");
        }

        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_CabinSurfaceMetal_Edit))]
        public JsonResult _EditSurfaceMetal(string ItemId, string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_SurfaceMetals, int.Parse(ItemId), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, InformationManager.SurfaceMetal_Get(int.Parse(ItemId)).ToString());
        ...
        [Authorize(Roles = nameof(OPERATIONS.Setting_CabinPanel))]
        ...
        //########################### PanelModel ##########################################
        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_CabinPanel_Add))]
        public ActionResult AddPanelModel(string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_CabinPanels, panelId, User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, InformationManager.Cabin_Panel_Get(panelId).ToString());
            return RedirectToAction("CabinPanel");
        }

        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_CabinPanel_Delete))]
        public ActionResult DeletePanelModel(string ItemId)
        {
            InformationManager.Cabin_Panel_Delete(int.Parse(ItemId));
            LogManager.Log_Logs_Add((int)DB_Table.Tb_CabinPanels, int.Parse(ItemId), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف پنل داخل کابین: " + InformationManager.Cabin_Panel_Get(int.Parse(ItemId)).Name);
            return RedirectToAction("CabinPanel");
        }

        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_CabinPanel_Edit))]
        public JsonResult EditPanelModel(string ItemId, string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable, string ItemSurfaceArea, byte? ItemStartFrom, int? ItemHeight, int? ItemWidth, int? ItemDepth)
        {
            ...
            if (User.IsInRole(nameof(BaseSite.Models.OPERATIONS.Setting_SurfaceArea)))
            {
            ...
            if (User.IsInRole(nameof(BaseSite.Models.OPERATIONS.Setting_Size)))
            {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_CabinPanels, int.Parse(ItemId), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, InformationManager.Cabin_Panel_Get(int.Parse(ItemId)).ToString());
        ...
        [Authorize(Roles = nameof(OPERATIONS.Setting_HallPanel))]
        ...
        //################################ PanelModel #######################################################
        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_HallPanel_Add))]
        public ActionResult AddHallPanelModel(string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_HallPanels, panelId, User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, InformationManager.Hall_Panel_Get(panelId).ToString());
            return RedirectToAction("HallPanel");
        }

        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_HallPanel_Delete))]
        public ActionResult DeleteHallPanelModel(string ItemId)
        {
            InformationManager.Hall_Panel_Delete(int.Parse(ItemId));
            LogManager.Log_Logs_Add((int)DB_Table.Tb_HallPanels, int.Parse(ItemId), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف پنل طبقات: " + InformationManager.Hall_Panel_Get(int.Parse(ItemId)).Name);
            return RedirectToAction("HallPanel");
        }

        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_HallPanel_Edit))]
        public JsonResult EditHallPanelModel(string ItemId, string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable, string ItemSurfaceArea, byte? ItemStartFrom, int? ItemHeight, int? ItemWidth, int? ItemDepth)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_HallPanels, int.Parse(ItemId), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, InformationManager.Hall_Panel_Get(int.Parse(ItemId)).ToString());
        ...
        //################################# SurfaceMetal ####################################################
        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_HallSurfaceMetal_Add))]
        ...
        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_HallSurfaceMetal_Delete))]
        ...
        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_HallSurfaceMetal_Edit))]
        ...
        [Authorize(Roles = nameof(OPERATIONS.Setting_DoorTopPanel))]
        ...
        //########################### PanelModel #############################################################
        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_DoorTopPanel_Add))]
        public ActionResult AddDoorTopPanelModel(string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_DoorTopPanels, panelId, User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, InformationManager.DoorTop_Panel_Get(panelId).ToString());
            return RedirectToAction("DoorTopPanel");
        }

        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_DoorTopPanel_Delete))]
        public ActionResult DeleteDoorTopPanelModel(string ItemId)
        {
            InformationManager.DoorTop_Panel_Delete(int.Parse(ItemId));
            LogManager.Log_Logs_Add((int)DB_Table.Tb_DoorTopPanels, int.Parse(ItemId), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف پنل سردرب: " + InformationManager.DoorTop_Panel_Get(int.Parse(ItemId)).Name);
            return RedirectToAction("DoorTopPanel");
        }

        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_DoorTopPanel_Edit))]
        public JsonResult EditDoorTopPanelModel(string ItemId, string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable, string ItemSurfaceArea, byte? ItemStartFrom, int? ItemHeight, int? ItemWidth, int? ItemDepth)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_DoorTopPanels, int.Parse(ItemId), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, InformationManager.DoorTop_Panel_Get(int.Parse(ItemId)).ToString());

            return Json(res.First(), null);
        }


        [Authorize(Roles = nameof(OPERATIONS.Setting_ProductFactorCost) + "," + nameof(OPERATIONS.Setting_CollectiveProducePercent))]
        ...
        //########################### ProductFactorCost #######################################################
        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_ProductFactorCost_Add))]
        public ActionResult AddProductFactorCost(string shApplyDate, double cost)
        {
            try
            {
                ...
                LogManager.Log_Logs_Add((int)DB_Table.Others, 0, User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, string.Format("افزودن ارزش ریالی ضریب کارکرد: اعمال از تاریخ {0} ارزش ریالی {1} ریال", shApplyDate, cost.ToString()));
        ...
        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_ProductFactorCost_Delete))]
        public ActionResult DeleteProductFactorCost(string shDate)
        {
            try
            {
                ...
                LogManager.Log_Logs_Add((int)DB_Table.Others, 0, User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, string.Format("حذف ارزش ریالی ضریب کارکرد: اعمال از تاریخ {0}", shDate));
                return RedirectToAction("ProductFactor");
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_CollectiveProducePercent_Add))]
        public ActionResult AddCollectiveProducePercent(string shApplyDate, double percent)
        {
            try
            {
                ...
                LogManager.Log_Logs_Add((int)DB_Table.Others, 0, User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, string.Format("افزودن کاهش ضریب در تولید تیراژی: اعمال از تاریخ {0} درصد کاهش {1} درصد", shApplyDate, percent.ToString()));
                return RedirectToAction("ProductFactor");
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_CollectiveProducePercent_Delete))]
        public ActionResult DeleteCollectiveProducePercent(string shDate)
        {
            try
            {
                ...
                LogManager.Log_Logs_Add((int)DB_Table.Others, 0, User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, string.Format("حذف کاهش ضریب در تولید تیراژی: اعمال از تاریخ {0}", shDate));
                return RedirectToAction("ProductFactor");
            }
            catch (Exception ex)
            {
        ...
        //####################################### TruthTable ############################################
        [Authorize(Roles = nameof(OPERATIONS.Setting_TruthTable))]
        ...
        [Authorize(Roles = nameof(OPERATIONS.Setting_TruthTable_Edit))]
        public JsonResult TruthTableEdit(int primaryTableId, int secondaryTableId, int primaryId, int secondaryId, double value)
        {
            ...
            return Json(res2, null);
        }


        //######################################### Store Products #########################################
        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_Product_Add))]
        public ActionResult AddProduct(string ItemName, string ItemDescription, string ItemCost, bool? ItemAvailable)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Products, productId, User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, InformationManager.Products_Get().Where(m => m.Id == productId).FirstOrDefault().ToString());
            return RedirectToAction("Product");
        }

        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_Product_Delete))]
        public ActionResult DeleteProduct(string ItemId)
        {
            InformationManager.Product_Delete(int.Parse(ItemId));
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Products, int.Parse(ItemId), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف محصول");
            return RedirectToAction("Product");
        }

        [HttpPost]
        [Authorize(Roles = nameof(OPERATIONS.Setting_Product_Edit))]
        public JsonResult EditProduct(string ItemId, string ItemName, string ItemDescription, string ItemCost, bool? ItemAvailable)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Products, int.Parse(ItemId), User.GetUserId(), HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, InformationManager.Products_Get().Where(m => m.Id == int.Parse(ItemId)).FirstOrDefault().ToString());

            return Json(res.First(), null);
        }

        [Authorize(Roles = nameof(OPERATIONS.Setting_Product))]
