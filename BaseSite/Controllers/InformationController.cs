    ...
    public class InformationController : BaseSiteController
    {
        ...
        public ActionResult CityDelete(string Countryid, string Provinceid, string Cityid)
        {
            if (!string.IsNullOrEmpty(Cityid))
            {
                ...
                LogManager.Log_Logs_Add((int)DB_Table.Others, int.Parse(Cityid), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف شهر: " + name);
            ...
            else if (!string.IsNullOrEmpty(Provinceid))
            {
                ...
                LogManager.Log_Logs_Add((int)DB_Table.Others, int.Parse(Provinceid), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف استان: " + name);
            ...
            else if (!string.IsNullOrEmpty(Countryid))
            {
                ...
                LogManager.Log_Logs_Add((int)DB_Table.Others, int.Parse(Countryid), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف کشور: " + name);
            }
        ...
        public ActionResult CityEdit(string Countryid, string CountryName, string Provinceid, string ProvinceName, string Cityid, string CityName)
        {
            if (!string.IsNullOrEmpty(Cityid))
            {
                ...
                LogManager.Log_Logs_Add((int)DB_Table.Others, int.Parse(Cityid), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, "تغییر نام شهر به " + CityName);
                return RedirectToAction("Cities", new { Countryid = Countryid, Provinceid = Provinceid });
            }
            else if (!string.IsNullOrEmpty(Provinceid))
            {
                InformationManager.Location_Province_Edit(int.Parse(Provinceid), ProvinceName);
                LogManager.Log_Logs_Add((int)DB_Table.Others, int.Parse(Provinceid), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, "تغییر نام استان به " + ProvinceName);
                return RedirectToAction("Cities", new { Countryid = Countryid, Provinceid = Provinceid });
            }
            else if (!string.IsNullOrEmpty(Countryid))
            {
                InformationManager.Location_Country_Edit(int.Parse(Countryid), CountryName);
                LogManager.Log_Logs_Add((int)DB_Table.Others, int.Parse(Countryid), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, "تغییر نام کشور به " + CountryName);
            }
            return RedirectToAction("Cities", new { Countryid = Countryid });
        }
        ...
        public ActionResult CityAdd(string Countryid, string CountryName, string Provinceid, string ProvinceName, string Cityid, string CityName)
        {
            if (!string.IsNullOrEmpty(CountryName))
            {
                ...
                LogManager.Log_Logs_Add((int)DB_Table.Others, int.Parse(Countryid), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, "افزودن کشور " + CountryName);
                return RedirectToAction("Cities", new { Countryid = Countryid });
            }
            else if (!string.IsNullOrEmpty(ProvinceName))
            {
                ...
                LogManager.Log_Logs_Add((int)DB_Table.Others, int.Parse(Provinceid), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, "افزودن استان " + ProvinceName);
                return RedirectToAction("Cities", new { Countryid = Countryid, Provinceid = Provinceid });
            }
            else if (!string.IsNullOrEmpty(CityName))
            {
                ...
                LogManager.Log_Logs_Add((int)DB_Table.Others, int.Parse(Cityid), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, "افزودن شهر " + CityName);
            }
            return RedirectToAction("Cities", new { Countryid = Countryid, Provinceid = Provinceid });
        }
        ...
        public ActionResult AddPack(string PackName)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Others, PackId, CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, "افزودن بسته بندی " + PackName);
        ...
        public ActionResult DeletePack(string PackId)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Others, int.Parse(PackId), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف بسته بندی");
            return RedirectToAction("Order");
        }
        ...
        public ActionResult EditPack(string PackId, string PackName)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Others, int.Parse(PackId), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, "تغییر نام بسته بندی به " + PackName);
            return RedirectToAction("Order");
        }
        ...
        public ActionResult AddElevatorBoard(string ElevatorBoardName)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Others, ElevatorBoardId, CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, "افزودن تابلوی " + ElevatorBoardName);
            return RedirectToAction("Order");
        }
        ...
        public ActionResult DeleteElevatorBoard(string ElevatorBoardId)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Others, int.Parse(ElevatorBoardId), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف تابلو");
            return RedirectToAction("Order");
        }
        ...
        public ActionResult EditElevatorBoard(string ElevatorBoardId, string ElevatorBoardName)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Others, int.Parse(ElevatorBoardId), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, "تغییر نام تابلو به " + ElevatorBoardName);
            return RedirectToAction("Order");
        }
        ...
        public ActionResult AddDeduction(string DeductionName)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Deductions, deductionId, CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, "افزودن کسورات " + DeductionName);
            return RedirectToAction("Order");
        }
        ...
        public ActionResult DeductionDelete(string DeductionId)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Deductions, int.Parse(DeductionId), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف کسورات");
            return RedirectToAction("Order");
        }
        ...
        public ActionResult DeductionEdit(string DeductionId, string DeductionName)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Deductions, int.Parse(DeductionId), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, "تغییر نام کسورات به " + DeductionName);
            return RedirectToAction("Order");
        }
        ...
        public ActionResult AddAddition(string AdditionName)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Additions, AdditionId, CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, "افزودن اضافات " + AdditionName);
            return RedirectToAction("Order");
        }
        ...
        public ActionResult AdditionDelete(string AdditionId)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Additions, int.Parse(AdditionId), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف اضافات");
            return RedirectToAction("Order");
        }
        ...
        public ActionResult AdditionEdit(string AdditionId, string AdditionName)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Additions, int.Parse(AdditionId), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, "تغییر نام اضافات به " + AdditionName);
            return RedirectToAction("Order");
        }
        ...
        public ActionResult AddAttachment(string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable, bool? IsDeliveryItem)
        {
            ...
            if (CustomAuthorizeAttribute.isAuthorize(HttpContext, BaseSite.Models.OPERATIONS.Setting_Cost))
            {
            ...
            if (CustomAuthorizeAttribute.isAuthorize(HttpContext, BaseSite.Models.OPERATIONS.Setting_ProductFactor))
            {
                if (!string.IsNullOrEmpty(ItemProductFactor)) facotr = double.Parse(ItemProductFactor);
            }
            if (CustomAuthorizeAttribute.isAuthorize(HttpContext, BaseSite.Models.OPERATIONS.Setting_Available))
            {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Attachments, attachmentId, CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, InformationManager.Order_Attachment_Get().Where(m => m.Id == attachmentId).FirstOrDefault().ToString());
        ...
        public ActionResult DeleteAttachment(string ItemId)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Attachments, int.Parse(ItemId), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف ملحقات");
            return RedirectToAction("Attachment");
        }
        ...
        public JsonResult EditAttachment(string ItemId, string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable, bool? IsDeliveryItem)
        {
            ...
            bool? available = null;
            bool? isDeliveryItem = null;
            if (!CustomAuthorizeAttribute.isAuthorize(HttpContext, BaseSite.Models.OPERATIONS.Setting_Name))
            {
                ItemName = null;
            }
            if (!CustomAuthorizeAttribute.isAuthorize(HttpContext, BaseSite.Models.OPERATIONS.Setting_Description))
            {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Attachments, int.Parse(ItemId), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, InformationManager.Order_Attachment_Get().Where(m => m.Id == int.Parse(ItemId)).FirstOrDefault().ToString());
        ...
        public ActionResult AddPushButton(string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_PushButtons, pushbuttonId, CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, InformationManager.Cabin_PushButton_Get(pushbuttonId).ToString());
        ...
        public ActionResult DeletePushButton(string ItemId)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_PushButtons, int.Parse(ItemId), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف پوش باتون: " + InformationManager.Cabin_PushButton_Get(int.Parse(ItemId)).Name);
            return RedirectToAction("PushButton");
        }
        ...
        public JsonResult EditPushButton(string ItemId, string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_PushButtons, int.Parse(ItemId), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, InformationManager.Cabin_PushButton_Get(int.Parse(ItemId)).ToString());
        ...
        public ActionResult AddMonitor(string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Monitors, monitorId, CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, InformationManager.Cabin_Monitor_Get(monitorId).ToString());
        ...
        public ActionResult DeleteMonitor(string ItemId)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Monitors, int.Parse(ItemId), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف نمایشگر: " + InformationManager.Cabin_Monitor_Get(int.Parse(ItemId)).Name);
            return RedirectToAction("Monitor");
        }
        ...
        public JsonResult EditMonitor(string ItemId, string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Monitors, int.Parse(ItemId), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, InformationManager.Cabin_Monitor_Get(int.Parse(ItemId)).ToString());
        ...
        public ActionResult _AddSurfaceMetal(string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_SurfaceMetals, surfacemetalId, CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, InformationManager.SurfaceMetal_Get(surfacemetalId).ToString());
        ...
        public ActionResult _DeleteSurfaceMetal(string ItemId)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_SurfaceMetals, int.Parse(ItemId), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف فلزرویه: " + InformationManager.SurfaceMetal_Get(int.Parse(ItemId)).Name);
            return RedirectToAction("SurfaceMetal");
        }
        ...
        public JsonResult _EditSurfaceMetal(string ItemId, string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_SurfaceMetals, int.Parse(ItemId), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, InformationManager.SurfaceMetal_Get(int.Parse(ItemId)).ToString());
        ...
        public ActionResult AddPanelModel(string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_CabinPanels, panelId, CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, InformationManager.Cabin_Panel_Get(panelId).ToString());
        ...
        public ActionResult DeletePanelModel(string ItemId)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_CabinPanels, int.Parse(ItemId), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف پنل داخل کابین: " + InformationManager.Cabin_Panel_Get(int.Parse(ItemId)).Name);
            return RedirectToAction("CabinPanel");
        }
        ...
        public JsonResult EditPanelModel(string ItemId, string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable, string ItemSurfaceArea, byte? ItemStartFrom, int? ItemHeight, int? ItemWidth, int? ItemDepth)
        {
            ...
            if (CustomAuthorizeAttribute.isAuthorize(HttpContext, BaseSite.Models.OPERATIONS.Setting_SurfaceArea))
            {
            ...
            if (CustomAuthorizeAttribute.isAuthorize(HttpContext, BaseSite.Models.OPERATIONS.Setting_Size))
            {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_CabinPanels, int.Parse(ItemId), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, InformationManager.Cabin_Panel_Get(int.Parse(ItemId)).ToString());
        ...
        public ActionResult AddHallPanelModel(string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_HallPanels, panelId, CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, InformationManager.Hall_Panel_Get(panelId).ToString());
        ...
        public ActionResult DeleteHallPanelModel(string ItemId)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_HallPanels, int.Parse(ItemId), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف پنل طبقات: " + InformationManager.Hall_Panel_Get(int.Parse(ItemId)).Name);
            return RedirectToAction("HallPanel");
        }
        ...
        public JsonResult EditHallPanelModel(string ItemId, string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable, string ItemSurfaceArea, byte? ItemStartFrom, int? ItemHeight, int? ItemWidth, int? ItemDepth)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_HallPanels, int.Parse(ItemId), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, InformationManager.Hall_Panel_Get(int.Parse(ItemId)).ToString());
        ...
        public ActionResult AddDoorTopPanelModel(string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_DoorTopPanels, panelId, CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, InformationManager.DoorTop_Panel_Get(panelId).ToString());
        ...
        public ActionResult DeleteDoorTopPanelModel(string ItemId)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_DoorTopPanels, int.Parse(ItemId), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف پنل سردرب: " + InformationManager.DoorTop_Panel_Get(int.Parse(ItemId)).Name);
            return RedirectToAction("DoorTopPanel");
        }
        ...
        public JsonResult EditDoorTopPanelModel(string ItemId, string ItemName, string ItemDescription, string ItemCost, string ItemProductFactor, bool? ItemAvailable, string ItemSurfaceArea, byte? ItemStartFrom, int? ItemHeight, int? ItemWidth, int? ItemDepth)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_DoorTopPanels, int.Parse(ItemId), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, InformationManager.DoorTop_Panel_Get(int.Parse(ItemId)).ToString());
        ...
        public ActionResult AddProductFactorCost(string shApplyDate, double cost)
        {
            try
            {
                ...
                LogManager.Log_Logs_Add((int)DB_Table.Others, 0, CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, string.Format("افزودن ارزش ریالی ضریب کارکرد: اعمال از تاریخ {0} ارزش ریالی {1} ریال", shApplyDate, cost.ToString()));
        ...
        public ActionResult DeleteProductFactorCost(string shDate)
        {
            try
            {
                ...
                LogManager.Log_Logs_Add((int)DB_Table.Others, 0, CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, string.Format("حذف ارزش ریالی ضریب کارکرد: اعمال از تاریخ {0}", shDate));
                return RedirectToAction("ProductFactor");
            }
            catch (Exception ex)
            {
        ...
        public ActionResult AddCollectiveProducePercent(string shApplyDate, double percent)
        {
            try
            {
                ...
                LogManager.Log_Logs_Add((int)DB_Table.Others, 0, CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, string.Format("افزودن کاهش ضریب در تولید تیراژی: اعمال از تاریخ {0} درصد کاهش {1} درصد", shApplyDate, percent.ToString()));
                return RedirectToAction("ProductFactor");
            }
            catch (Exception ex)
            {
        ...
        public ActionResult DeleteCollectiveProducePercent(string shDate)
        {
            try
            {
                ...
                LogManager.Log_Logs_Add((int)DB_Table.Others, 0, CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, string.Format("حذف کاهش ضریب در تولید تیراژی: اعمال از تاریخ {0}", shDate));
                return RedirectToAction("ProductFactor");
            }
            catch (Exception ex)
            {
        ...
        public ActionResult AddProduct(string ItemName, string ItemDescription, string ItemCost, bool? ItemAvailable)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Products, productId, CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Add, InformationManager.Products_Get().Where(m => m.Id == productId).FirstOrDefault().ToString());
        ...
        public ActionResult DeleteProduct(string ItemId)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Products, int.Parse(ItemId), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Delete, "حذف محصول");
            return RedirectToAction("Product");
        }
        ...
        public JsonResult EditProduct(string ItemId, string ItemName, string ItemDescription, string ItemCost, bool? ItemAvailable)
        {
            ...
            LogManager.Log_Logs_Add((int)DB_Table.Tb_Products, int.Parse(ItemId), CustomAuthorizeAttribute.getCurrentUser(HttpContext).Id, HttpContext.Connection.RemoteIpAddress?.ToString(), (int)LogActivity.Edit, InformationManager.Products_Get().Where(m => m.Id == int.Parse(ItemId)).FirstOrDefault().ToString());
