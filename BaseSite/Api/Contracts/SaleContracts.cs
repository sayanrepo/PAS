...
public sealed class SaleSearch : IValidatableObject
{
    ...
    public bool HasFilters => DocumentNumber.HasValue || CustomerId.HasValue || !string.IsNullOrWhiteSpace(Customer)
        || StatusId.HasValue || TradeTypeId.HasValue
...
public sealed class SaleDetail {
 public SaleSummary Summary { get; set; } = new();
